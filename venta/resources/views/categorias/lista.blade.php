        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="text-right">
                <a href="{{route('categorias.create')}}" class="h-2 flex gap-2 btn btn-primary my-4 p-2 text-white hover:text-white">
            ...
            <div class="my-4 flex justify-end space-x-2" style="display: flex;justify-content: end;margin-right: 30px;">
                <button onclick="exportToPDF('categorias')" style="background-color: #e34444" class="btn mr-2 inline-block px-2 py-1 rounded-lg font-bold text-sm text-white bg-red-600 hover:bg-red-700 transition-colors">
                ...
                <button onclick="exportToExcel('categorias')" style="background-color: #3d8d3d" class="btn inline-block px-2 py-1 rounded-lg font-bold text-sm text-white bg-green-600 hover:bg-green-700 transition-colors">
                  ...
                  <tbody>
                    @foreach($categorias as $categoria)
                        <tr class="text-center">
                            ...
                            <td>
                                <p class="text-xs font-weight-bold mb-0">{{ $categoria->codigo }}</p>
                            </td>
                            <td>
                            ...
                            <td class=" px-3 py-2 exclude-column">
                                ...
                                <a href="{{ route('categorias.edit', $categoria->id) }}" style="border-radius: 50px !important; border:none !important" class="inline-block px-2 py-2 rounded-lg font-bold text-white bg-blue-600 hover:bg-blue-700 transition-colors">
...
<script>
    new DataTable('#example', {
        ...
        language: {
            emptyTable: "Aún no hay categorías que mostrar."
        }
    });
