        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="my-4 flex justify-end space-x-2" style="display: flex;justify-content: end;margin-right: 30px;">
                <button onclick="exportToPDF('subcategoria')" style="background-color: #e34444" class="btn mr-2 inline-block px-2 py-1 rounded-lg font-bold text-sm text-white bg-red-600 hover:bg-red-700 transition-colors">
                ...
                <button onclick="exportToExcel('subcategoria')" style="background-color: #3d8d3d" class="btn inline-block px-2 py-1 rounded-lg font-bold text-sm text-white bg-green-600 hover:bg-green-700 transition-colors">
                ...
                <table id="example" class="table align-items-center mb-0 hover">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase  text-xxs font-weight-bolder opacity-7">Subcategoría</th>
                      <th class="text-center text-uppercase  text-xxs font-weight-bolder opacity-7">Categoría</th>
                  ...
                  <tbody>
                    @foreach($subcategorias as $subcategoria)
                        <tr class="text-center">
                            ...
                            <td>
                                <img src="{{ asset('uploads/' . $subcategoria->imagen) }}" alt="Imagen de la subcategoria" style="height: 80px; border-radius:17px">
                            </td>
                            <td>
                            ...
                            <td>
                                <p class="text-xs font-weight-bold mb-0">{{ $subcategoria->descripcion }}</p>
                            </td>
                            <td>
                            ...
                            <td class=" px-3 py-2 exclude-column">
                                ...
                                <a href="{{ route('subcategorias.edit', $subcategoria->id) }}" style="border-radius: 50px !important; border:none !important" class="inline-block px-2 py-2 rounded-lg font-bold text-white bg-blue-600 hover:bg-blue-700 transition-colors">
