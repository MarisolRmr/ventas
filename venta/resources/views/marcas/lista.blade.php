        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="text-right">
                <a href="{{route('marcas.create')}}" class="h-2 flex gap-2 btn btn-primary my-4 p-2 text-white hover:text-white">
            ...
            <div class="my-4 flex justify-end space-x-2" style="display: flex;justify-content: end;margin-right: 30px;">
                    <button onclick="exportToPDF('marcas')" style="background-color: #e34444" class="btn mr-2 inline-block px-2 py-1 rounded-lg font-bold text-sm text-white bg-red-600 hover:bg-red-700 transition-colors">
                    ...
                    <button onclick="exportToExcel('marcas')" style="background-color: #3d8d3d" class="btn inline-block px-2 py-1 rounded-lg font-bold text-sm text-white bg-green-600 hover:bg-green-700 transition-colors">
                  ...
                  <tbody>
                    @foreach($marcas as $marca)
                        <tr class="text-center">
                            ...
                            <td>
                                <p class="text-xs font-weight-bold mb-0">{{ $marca->nombre }}</p>
                            </td>
                            <td>
                                <img src="{{ asset('uploads/' . $marca->imagen) }}" alt="Imagen de la marca" style="height: 80px; border-radius:17px">
                            </td>
                            <td>
                                <p class="text-xs font-weight-bold mb-0">{{ $marca->descripcion }}</p>
                            </td>
                            <td>
                                <a href="#" ><p class="text-xs font-weight-bold mb-0">{{ $marca->usuario->username }}</p></a>
                            </td>
                            <td class=" px-3 py-2 exclude-column">
                                ...
                                <a href="{{ route('marcas.edit', $marca->id) }}" style="border-radius: 50px !important; border:none !important" class="inline-block px-2 py-2 rounded-lg font-bold text-white bg-blue-600 hover:bg-blue-700 transition-colors">
...
<script>
    new DataTable('#example', {
        ...
        language: {
            emptyTable: "Aún no hay marcas que mostrar."
        }
    });
