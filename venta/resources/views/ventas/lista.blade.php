        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="my-4 flex justify-end space-x-2" style="display: flex;justify-content: end;margin-right: 30px;">
                <button onclick="exportToPDF('ventas')" style="background-color: #e34444" class="btn mr-2 inline-block px-2 py-1 rounded-lg font-bold text-sm text-white bg-red-600 hover:bg-red-700 transition-colors">
                ...
                <button onclick="exportToExcel('ventas')" style="background-color: #3d8d3d" class="btn inline-block px-2 py-1 rounded-lg font-bold text-sm text-white bg-green-600 hover:bg-green-700 transition-colors">
                ...
                <table id="example" class="table align-items-center mb-0 hover">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase  text-xxs font-weight-bolder opacity-7">Detalles</th>
                    </tr>
                  </thead>
                  <tbody>
